...
categories=["background","aeroplane","bicycle","bird","boat",
           "bottle","bus","car","cat","chair","cow","diniingtable",
           "dog","horse","motorbike","person","pottedplant",
           "sheep","sofa","train","tvmobitor"]
def detect_objects_and_draw_boxes(net,image):
    ...
    for i in range(len(detections)):
        #each detection is of following format
        #[0, predicted_catergory,confidence_value,x1,y1,x2,y2]
        #aboce 1st value is always zero, x1,y1 top left, x2,y2 bottom right
